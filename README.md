...
1. Скачайте последнюю версию `cedar-folder-size-analyzer-<version>-x86_64.msi` из раздела [Releases](https://gitlab.com/yourusername/cedar-folder-size-analyzer/-/releases)
...
> **Примечание:** Релизы собираются автоматически через GitLab CI/CD при создании тегов. См. [GITLAB_CI.md](GITLAB_CI.md) для деталей.
...
Проект использует GitLab CI/CD для автоматической сборки релизов:

- ✅ Автоматическая сборка при создании тегов
- ✅ MSI установщик
- ✅ ZIP архив с исполняемым файлом
- ✅ Автоматическое создание GitLab Releases
...
GitLab CI автоматически соберёт и опубликует релиз с артефактами.

**Документация:**
- 🚀 [QUICKSTART.md](QUICKSTART.md) - Быстрый старт
- 📖 [GITLAB_CI.md](GITLAB_CI.md) - Подробная документация CI/CD
